<template>
  <a-form class="create-admin-step" ref="formRef" :model="formModel" :rules="rules" layout="vertical" autocomplete="off">
    <a-space direction="vertical">
      ...
      <a-form-item field="password" hide-label validate-trigger="blur">
        ...
        <a-input-password autocomplete="false" v-model="formModel.password" placeholder="请输入密码" allow-clear> </a-input-password>
      </a-form-item>
      <a-form-item field="re_password" hide-label validate-trigger="blur">
        <template #extra> 确认管理员密码 </template>
        <a-input-password autocomplete="false" v-model="formModel.re_password" placeholder="请确认密码" allow-clear> </a-input-password>
      </a-form-item>
    </a-space>
  </a-form>
</template>
